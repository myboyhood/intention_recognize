...
(cl:defmethod cl:initialize-instance :after ((m <user_IDs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'user_IDs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinect2_tracker-msg:<user_IDs> is deprecated: use kinect2_tracker-msg:user_IDs instead.")))
